...
# 我相信以各位医学生贫瘠的计算机知识压根就没听懂上面这三大坨都是什么东西
# 没关系，上面只是定义，下面是简明易懂的解释，就像你上了临床在按压麦氏点时不会背解剖书，而是会"对着这块按一把"

# 服务器：就像医院的挂号窗口，负责接收病人的请求（比如挂号、问诊），然后分配到对应的科室处理。
# 数据库：就像医院的病历档案室，负责存储所有病人的信息、诊断记录、处方等数据，需要时可以查询和更新。
# API：就像医院的各种表格和流程，规定了怎么挂号、怎么开药、怎么查询报告，让医患之间的沟通有章可循。

# 光在这里看大概没法理解这些内容，下面我写一个示范代码
...
fake_database = {
    "users": [
        {"id": 1, "name": "张三", "age": 20, "major": "临床医学"},
        {"id": 2, "name": "李四", "age": 21, "major": "口腔医学"},
        {"id": 3, "name": "王五", "age": 22, "major": "预防医学"}
    ]
}
...
# 推荐学习资源：
# =====================================================
# - Python Flask入门：https://www.bilibili.com/video/BV1Z44y1p7xM
# - 后端开发基础：https://www.bilibili.com/video/BV1gV411f7sR
# - RESTful API设计指南：https://www.bilibili.com/video/BV1W44y1J7Yx
